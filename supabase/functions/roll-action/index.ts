...
//
// Фора нужна на доставку события по Realtime. Первые замеры на живом проекте
// дали около 360 мс от записи до получения гостем — 350 мс не хватало, событие
// приходило уже после назначенного момента. Взято с запасом: на фоне
// семисекундного вращения лишние полсекунды ожидания незаметны, а вот старт
// с середины заметен сразу.
const SPIN_DURATION_MS = 7200;
const SPIN_LEAD_MS = 1200;
