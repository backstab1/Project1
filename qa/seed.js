...
const movies = [
  ...
  createMovie({ id: "qa-long", title: "Невероятная история о человеке, который отправился смотреть кино и случайно изменил весь мир", categoryId: "qa-world", categoryPosition: 0, releaseYear: 2024, durationMinutes: 147, country: "Россия", coverUrl: "/qa/missing-poster.jpg" }),
  createMovie({ id: "qa-hunt", title: "Охота", originalTitle: "Jagten", categoryId: "qa-scandinavia", categoryPosition: 0, releaseYear: 2012, durationMinutes: 115, country: "Дания", genres: ["Драма"], isFavorite: true, tags: ["Тяжёлое кино", "Пересмотр"], notes: "Смотреть только в спокойный вечер: очень выматывает.", watchedAt, ratings: [{ participantName: "Антон", value: 9.5 }, { participantName: "Мария", value: 9 }] }),
  ...
  createMovie({ id: "qa-arrival", title: "Прибытие", categoryId: "qa-fantasy", categoryPosition: 3, releaseYear: 2016, durationMinutes: 116, country: "США", genres: ["Фантастика", "Драма"], isFavorite: true, tags: ["Пересмотр"] }),
